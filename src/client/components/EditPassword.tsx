...
export default function EditPasswordForm({ error }: Props) {
    return (
        <div id="registerDiv" class="p-6">
            <p class="text-gray-500 text-sm mb-6">Inserisci la vecchia password e scegline una nuova.</p>

            <form
                hx-post="/editPassword"
