    ...
    return (
        ...
        <div class="container mx-auto p-4">
            ...
            <h1 class="text-3xl font-extrabold tracking-tight text-gray-900 px-6 pt-8 max-w-7xl mx-auto">
                Cart di {session?.username ? session.username : "utente"}
            </h1>

            <div class="flex flex-col gap-4">
                {orders.map((order) => (
                    <div class="flex items-center gap-6 bg-white border border-gray-200 rounded-2xl shadow-sm p-4 hover:shadow-md transition-shadow">
