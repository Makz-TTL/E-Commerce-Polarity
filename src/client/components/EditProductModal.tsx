        ...
        >
          <div class="flex-1 overflow-y-auto p-6 space-y-4">
            ...
            <div class="space-y-3 pt-2">
              ...
              <p class="text-xs text-gray-400">Le nuove immagini caricate sostituiranno quelle esistenti. Lascia vuoto per mantenerle.</p>
        ...
        {`
          ...
          window.updateCoverIndices = function() {
            ...
            cards.forEach((card, idx) => {
              ...
              radio.value = idx;
              if (radio.checked) { hasChecked = true; card.classList.remove('border-transparent'); card.classList.add('border-indigo-600', 'ring-2', 'ring-indigo-100'); }
            });
            if (!hasChecked && cards.length > 0) {
              const firstRadio = cards[0].querySelector('input[type="radio"]');
              firstRadio.checked = true; firstRadio.onchange();
            }
          };
        `}
      </script>
