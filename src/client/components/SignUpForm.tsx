            ...
            >
                <div class="flex gap-3">
                    <div class="flex-1">
                        ...
                        <input type="text" name="nome" value={values.nome || ""} required pattern="[^\s]+"
                    ...
                    <div class="flex-1">
                        ...
                        <input type="text" name="cognome" value={values.cognome || ""} required pattern="[^\s]+"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
                        {errors?.cognome && (
                ...
                <div>
                    ...
                    <input type="text" name="username" value={values.username || ""} required pattern="[^\s]+"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    {errors?.username && (
